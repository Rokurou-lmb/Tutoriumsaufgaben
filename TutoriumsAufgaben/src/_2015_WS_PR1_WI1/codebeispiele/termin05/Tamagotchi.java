package _2016_WS_PR1_WI1.codebeispiele.termin05;
...
/**
 * Diese Klasse repräsentiert ein Tamagotchi. Durch Eingabe von Kommandos
...
public class Tamagotchi {
	...
	public void tick(){
		...
		if (hunger>3){
			System.out.println("Tamagotchi: Ich habe Hunger! Bitte füttere mich...");
		}
		if(langeweile>3){
			System.out.println("Tamagotchi: Mir ist langweilig! Spiel mit mir...");
		}
		if(muedigkeit>3){
			System.out.println("Tamagotchi: Ich bin Müde! Bring mich ins Bett...");
		}
	}
	...
	/**
	 * 
	 * Vergleicht übergebenes Kommando mit möglichen Kommandos und
	...
	public static void main(String[] args) {
		...
		while (!kommando.equalsIgnoreCase("ende")) {
			...
			System.out.println("Mögliche Kommandos: iss, spiel, schlaf, nichts, ende");
